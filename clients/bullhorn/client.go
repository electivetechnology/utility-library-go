...
func (client BaseClient) GetBaseUrl() string {
...
func (client BaseClient) GetTtl() int {
	return client.Ttl
}

func (client BaseClient) GetApiVersion() string {
	return client.ApiVersion
}

func (client BaseClient) GetRestToken() string {
...
func (client *BaseClient) SetHttpClient(httpClient *http.Client) {
	client.HttpClient = httpClient
}

func (client BaseClient) GetHttpClient() *http.Client {
